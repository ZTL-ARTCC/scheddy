<script lang="ts">
	...
	import {TimeGrid,DayGrid,List,ResourceTimeline,ResourceTimeGrid,Interaction,Calendar} from '@event-calendar/core';
	...
	let options = $derived({
		...
		events: data.mentorSessions.map((u) => {
			...
			const backgroundColors = ['#991b1b','#9a3412','#92400e','#854d0e','#3f6212','#166534','#065f46','#115e59','#155e75','#075985','#1e40af','#3730a3','#5b21b6','#6b21a8','#86198f','#9d174d','#9f1239'];
			const foregroundColors = ['#fef2f2','#fff7ed','#fffbeb','#fefce8','#f7fee7','#f0fdf4','#ecfdf5','#f0fdfa','#ecfeff','#f0f9ff','#eff6ff','#eef2ff','#f5f3ff','#faf5ff','#fdf4ff','#fdf2f8','#fff1f2'];
...
<div bind:this={container} class="ec-dark">
	<Calendar plugins={[TimeGrid,DayGrid,List,ResourceTimeline,ResourceTimeGrid,Interaction]} {options} />
</div>
